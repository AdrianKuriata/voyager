...
return [
    ...
    'generic' => [
        ...
        'are_you_sure_delete'    => 'Jesteś pewny, że chcesz to usunąć',
        ...
        'delete_question'        => 'Jesteś pewny, że chcesz to usunąć',
        'delete_this_confirm'    => 'Tak, usuń to',
        'deselect_all'           => 'Odznacz wszystkie',
        'download'               => 'Pobierz',
        'edit'                   => 'Edytuj',
        'email'                  => 'E-mail',
        'error_deleting'         => 'Wygląda na to, że wystąpił problem podczas usuwania',
        'exception'              => 'Ostrzeżenie',
        'featured'               => 'Opis',
        ...
        'items'                  => 'przedmiot(y)',
        'keep_sidebar_open'      => 'Yarr! Opuść kotwicę! (i otwórz pasek boczny)',
        'key'                    => 'Klucz',
        'last_modified'          => 'Ostatnio modyfikowany',
        'length'                 => 'Długość',
        'login'                  => 'Login',
        'media'                  => 'Biblioteka',
        'menu_builder'           => 'Stwórz menu',
        'move'                   => 'Przenieś',
        'name'                   => 'Name',
        'new'                    => 'Nowy',
        'no'                     => 'Nie',
        'no_thanks'              => 'Nie dziękuję',
        'not_null'               => 'Nie jest zerem',
        'options'                => 'Opcje',
        'password'               => 'Hasło',
        ...
        'rename'                 => 'Zmień nazwę',
        'required'               => 'Wymagany',
        'return_to_list'         => 'Powróć do listy',
        'route'                  => 'Route',
        'save'                   => 'Zapisz',
        'search'                 => 'Szukaj',
        'select_all'             => 'Zaznacz wszystkie',
        'settings'               => 'Ustawienia',
        'showing_entries'        => 'Pokazano :from do :to z :all wartości|Pokazano :from do :to z :all wartości',
        'submit'                 => 'Wyślij',
        'successfully_added_new' => 'Poprawnie dodano nowy',
        'successfully_deleted'   => 'Poprawnie usunięto',
    ...
    'login' => [
        ...
        'welcome'      => 'Witaj w Voyager. Odnalezionym panelu administracyjnym dla Laravel',
    ],
    ...
    'settings' => [
        ...
        'new'                  => 'Nowe ustawienie',
        'help_name'            => 'Ustaw nazwę: Tytuł Admin',
        'help_key'             => 'Ustaw wartość: admin_title',
        ...
        'delete_confirm'       => 'Tak, usuń ustawienie',
        'successfully_created' => 'Poprawnie utworzono ustawienie',
        'successfully_saved'   => 'Poprawnie zapisano ustawienie',
        'successfully_deleted' => 'Poprawnie usunięto ustawienie',
        'already_at_top'       => 'Aktualnie jest na górze listy',
        'already_at_bottom'    => 'Aktualnie jest na dole listy',
        'moved_order_up'       => 'Przenieś :name w górę',
        'moved_order_down'     => 'Przenieś :name w dół',
        'successfully_removed' => 'Poprawnie usunięto :name wartość',
    ],

    'media' => [
        'add_new_folder'         => 'Dodaj nowy folder',
        'audio_support'          => 'Twoja przeglądarka nie wspiera elementów dźwiękowych.',
        'create_new_folder'      => 'Utwórz nowy folder',
        'delete_folder_question' => 'Usunięcie folderu usunie też jego całą zawartość',
        'destination_folder'     => 'Miejsce folderu',
        'drag_drop_info'         => 'Zaznacz i przenieś pliki lub kliknij przycisk wrzuć',
        'error_already_exists'   => 'Przepraszamy, ale aktualnie plik/folder istnieje o takiej nazwie w tym folderze.',
        ...
        'folder_exists_already'  => 'Sorry that folder already exists, please delete that folder if you wish '.
                                    'to re-create it',
        'image_does_not_exist'   => 'Zdjęcie nie istnieje',
        'image_removed'          => 'Zdjęcie usunięte',
        'library'                => 'Biblioteka plików',
        'loading'                => 'ŁADOWANIE PLIKÓW Z BIBLIOTEKI',
        'move_file_folder'       => 'Przenieś plik/folder',
        'new_file_folder'        => 'Nowa nazwa pliku/folderu',
        'new_folder_name'        => 'Nowa nazwa folderu',
        'no_files_here'          => 'Nie znaleziono plików.',
        'no_files_in_folder'     => 'Nie znaleziono plików w tym folderze.',
        'nothing_selected'       => 'Nie zaznaczono pliku lub folderu',
        'rename_file_folder'     => 'Zmień nazwę pliku/folderu',
        'success_uploaded_file'  => 'Poprawnie dodano nowy plik!',
        'success_uploading'      => 'Poprawnie dodano nowe zdjęcie!',
        'uploading_wrong_type'   => 'Błąd wrzucania: Niewspierane rozszerzenie pliku lub plik jest za duży!',
        'video_support'          => 'Twoja przeglądarka nie wspiera oznaczeń filmów.',
    ],

    'menu_builder' => [
        'color'                => 'Kolor w RGB lub HEX (opcjonalnie)',
        'color_ph'             => 'Kolor (#ffffff lub rgb(255, 255, 255)',
        'create_new_item'      => 'Utwórz nowy odnośnik menu',
        'delete_item_confirm'  => 'Tak, usuń ten element menu',
        'delete_item_question' => 'Jesteś pewny, że chcesz usunąć ten element menu?',
        'drag_drop_info'       => 'Drag and drop the menu Items below to re-arrange them.',
        'dynamic_route'        => 'Dynamiczny odnośnik',
        'edit_item'            => 'Edytuj element menu',
        'icon_class'           => 'Font Icon class for the Menu Item (Use a',
        'icon_class2'          => 'Klasy czcionki Voyager</a>)',
        'icon_class_ph'        => 'Klasy ikon (opcjonalnie)',
        'item_route'           => 'Odnośnik dla elementu menu',
        'item_title'           => 'Tytuł dla elementu menu',
        'link_type'            => 'Typ odnośnika',
        'new_menu_item'        => 'Nowy element menu',
        'open_in'              => 'Otwórz w',
        'open_new'             => 'Nowej karcie/oknie',
        'open_same'            => 'Tej samej karcie/oknie',
        'route_parameter'      => 'Parametry odnośnika (jeśli są)',
        'static_url'           => 'Statyczny URL',
        'successfully_created' => 'Poprawnie utworzono element menu.',
        'successfully_deleted' => 'Poprawnie usunięto element menu.',
        'successfully_updated' => 'Poprawnie zaktualizowano element menu.',
        'updated_order'        => 'Poprawnie zaktualizowanie kolejność elementów w menu.',
